...
@interface PlayerViewController : UIViewController <CBCentralManagerDelegate, CBPeripheralDelegate, AVAudioPlayerDelegate>
{
...
@property (weak, nonatomic) IBOutlet UIImageView *component;
@property (weak, nonatomic) IBOutlet UIImageView *recorderLightRed;
@property (weak, nonatomic) IBOutlet UIImageView *playerPlayStop;
@property (nonatomic, strong) IBOutlet UILabel *trackNameplaying;
@property (nonatomic, strong) IBOutlet UILabel *trackTime;
